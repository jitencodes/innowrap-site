...
export default function Home() {
    const getData = (e)=>{
      ...
      const hero = getData(HiringBannerRPO)
  ...
  return (
    <main className="">
      ...
      <section className="relative flex px-6 md:px-12 lg:px-20 xl:px-40 flex-col items-center py-10 md:py-20 lg:py-24">
          <div className="flex tablet:items-center flex-col md:flex-row-reverse gap-8 mb-6 lg:mb-12">
                <div className="flex relative w-fit md:flex-1 flex-col md:h-full md:justify-center">
                  <h3 className='text-2xl lg:text-4xl text-black font-semibold'>End-to-End Recruiting</h3><br/> 
                  <p className='text-base lg:text-xl font-light text-black'>Great companies are built on the talent of their workforce. Finding and keeping the top personnel is one of HR leaders’ major concerns. Innowrap manages the entire recruitment process of RPO Services from start to finish with the aid of an effective and efficient recruitment strategy, and the delivery of the best people for each open position. <br/> <br/>If your company wants to improve the speed, agility, standardisation, and flexibility of its recruitment department, RPO is the ideal recruiting approach for you. </p>
      ...
      <section className="relative flex px-6 md:px-12 lg:px-20 xl:px-40 flex-col items-center bg-[#F1F4FB] py-10 md:py-16">
          ...
          <p className="text-black font-semibold text-2xl md:text-[40px] leading-snug text-center mb-8 md:mb-12">Our Process</p>
          ...
          <div className="flex -bottom-0 left-0 absolute h-[350px] w-screen -z-1">
            ...
            <button className='text-base font-semibold text-white transition-all duration-300 bg-gradient-1 rounded-[4px] shadow-bs-1 hover:shadow-none py-3 px-5 mb-7 md:my-14'>Hire Team Now</button>
      ...
      <div className="flex tablet:items-center flex-col md:flex-row-reverse gap-8 mb-6 lg:mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-12 lg:gap-20 xl:gap-24">
          <div className="flex flex-col justify-between md:h-[745px] lg:h-[655px]">
            <div className="">
              <p className='text-black font-semibold text-2xl md:text-[26px] lg:text-[32px] xl:text-[40px] leading-snug mb-3'>Why choose Innowrap ?</p>
              <p className='text-base lg:text-xl font-light text-black'>Innowrap is an affordable RPO provider for both small businesses and larger corporate firms. While offering recruitment processing outsourcing services, we deliver quality and value in the form of these features and benefits.</p>
            </div>
            ...
            <div className="block">
              <div className="flex mb-3 items-center">
                <Image
                      ...
                      quality={100}
                  />
                  <p className='text-black font-semibold text-2xl md:text-[22px] ml-6'>Competitive Rpo Solutions With High Quality</p>
              </div>
              <p className=''>The team members are well-versed in the recruitment process and screen candidates to ensure they have the necessary skills and qualities. Innowrap offers reasonably priced recruitment services without sacrificing service quality.</p>
            </div>
            <div className="block">
              <div className="flex mb-3 items-center">
                <Image
                      ...
                      quality={100}
                  />
                  <p className='text-black font-semibold text-base md:text-[22px] leading-snug ml-6'>Scalability</p>
              </div>
              <p className=''>Our customizable solutions enable you to scale your outsourcing up or down during high and low volume periods.</p>
            </div>
            <div className="block">
              <div className="flex mb-3 items-center">
                <Image
