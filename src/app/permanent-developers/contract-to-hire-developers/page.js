...
export default function Home() {
    const getData = (e)=>{
      ...
      const hero2 = getData(HiringBannerCHD)
  ...
  return (
    <main className="">
      ...
      <section className="relative flex px-6 md:px-12 lg:px-20 xl:px-40 flex-col items-center bg-gradient-to-b from-[#262DD2] to-[#2F53E8] pt-10 pb-32">
          ...
          <p className="text-white font-semibold text-2xl md:text-[40px] leading-snug text-center mb-2">A contract to hire developer from us ?</p>
                    ...
                    <div className=" max-w-[350px] md:max-w-[250px]">
                        <div className="flex justify-between">
                            <Image
                                ...
                                alt={item.altText}
                            />
                            <span className='text-[#8B89FF] font-thin text-6xl mr-10'>{idx+1}</span>
                        </div>
                        <p className="text-white font-semibold text-2xl -tracking-[0.02em] mb-4 mt-7">{item.title}</p>
          ...
          <div className="flex -bottom-0 left-0 absolute h-[350px] w-screen -z-1">
            ...
            <button className='text-base font-semibold text-black bg-white rounded-[4px] shadow-bs-1 hover:shadow-none py-3 px-5 mb-7 md:my-14'>Hire Team Now</button>
