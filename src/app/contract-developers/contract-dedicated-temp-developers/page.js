  ...
  return (
    <main className="">
      ...
      <section className="relative flex px-6 md:px-12 lg:px-20 xl:px-40 flex-col items-center bg-[#F1F4FB] pt-10 md:pt-20 lg:pt-24">
            <h2 className="text-black font-semibold text-2xl md:text-[40px] leading-snug text-center mb-8 md:mb-12">An Innovative Approach to Tech Recruiting</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 lg:gap-20 xl:gap-[124px]">
                <div className="flex flex-col -[50%]">
                  <h3 className='text-lg lg:text-4xl text-black font-semibold'><span className='text-blue'>Global Talent Database</span> and AI-Powered Intensive Vetting Process</h3><br/> 
                  <p className='text-base lg:text-xl font-light text-black'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In fermentum nulla non eros porttitor,<br/> <br/> vel tempor dui pulvinar. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut vel est non orci cursus pellentesque.<br/> <br/> Lorem ipsum dolor sit amet, consectetur adipiscing elit. In fermentum nulla non eros porttitor,</p>
                </div>
                <div className="flex relative h-[378px] lg:h-auto">
                <Image  className='absolute'
                ...
                <div className="flex flex-col justify-between">
                  <div className="block">
                  <h3 className='text-lg lg:text-4xl text-black font-semibold'><span className='text-blue'>Freedom to choose </span> developers as per your budget</h3><br/> 
                  <p className='text-base lg:text-xl font-light text-black'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In fermentum nulla non eros porttitor, vel tempor dui pulvinar. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut vel est non orci cursus</p>
                  </div>
                ...
                <div className="flex flex-col justify-between">
                  <div className="block">
                  <h3 className='text-lg lg:text-4xl text-black font-semibold mb-2'><span className='text-blue'>End to end developer </span> hiring and management</h3>
                  <p className='text-sm lg:text-base font-semibold text-black mb-2'>(Video Resume + Technical Test + Timesheet + Reviews + Billing + Macbook + Taxes + Project Manager)</p>
                  <p className='text-base lg:text-xl font-light text-black'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In fermentum nulla non eros porttitor, vel tempor dui pulvinar. Vestibulum ante ipsum primis in faucibus orci luctus.</p>
                  </div>
      ...
      <section className="px-6 md:px-12 lg:px-20 xl:px-40 mb-10 md:mb-20 xl:mb-28">
            <div className="relative overflow-hidden flex py-6 md:py-10 items-center w-full rounded-lg px-3 md:px-12 -z-10" style={{backgroundImage:'url(images/hiring-page/requirement-banner.png)', backgroundSize:'cover'}}>
                  <Image  className='absolute '
                          src="/images/hiring-page/requirement-banner.png"
                          fill
                          alt='back ground image'
